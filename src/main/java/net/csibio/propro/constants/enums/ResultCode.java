...
public enum ResultCode implements Serializable {
    ...
    SOME_EXPERIMENT_HAVE_NO_DEFAULT_OVERVIEW("SOME_EXPERIMENT_HAVE_NO_DEFAULT_OVERVIEW", "部分实验没有默认的实验概览"),
    ...
    EXP_IDS_CANNOT_BE_EMPTY("EXP_IDS_CANNOT_BE_EMPTY", "实验ID列表不能为空"),

    SOME_EXPERIMENT_NOT_EXISTED("SOME_EXPERIMENT_NOT_EXISTED", "部分实验数据不存在"),
