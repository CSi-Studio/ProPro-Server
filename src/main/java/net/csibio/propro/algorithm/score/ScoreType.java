...
//            null, false),
    ...
    public static List<String> usedScoreTypes() {
        ...
        scoreTypes.add(ScoreType.NormRtScore.getName());
        scoreTypes.add(ScoreType.LogSnScore.getName());
        scoreTypes.add(ScoreType.IonsCountDeltaScore.getName());
        scoreTypes.add(ScoreType.IntensityScore.getName());
        scoreTypes.add(ScoreType.IsotopeCorrelationScore.getName());
        scoreTypes.add(ScoreType.IsotopeOverlapScore.getName());
        ...
        scoreTypes.add(ScoreType.LibraryRsmd.getName());
        scoreTypes.add(ScoreType.LibraryDotprod.getName());
        scoreTypes.add(ScoreType.LibraryManhattan.getName());
        scoreTypes.add(ScoreType.LibrarySangle.getName());
        scoreTypes.add(ScoreType.LibraryRootmeansquare.getName());
        scoreTypes.add(ScoreType.MassdevScore.getName());
        scoreTypes.add(ScoreType.MassdevScoreWeighted.getName());
