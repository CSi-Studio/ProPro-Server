...
public abstract class Classifier {
    ...
    public TrainPeaks selectFirstTrainPeaks(TrainData trainData, LearningParams learningParams) {
        ...
        bestTargetScore.put(ScoreType.XcorrShapeW.getName(), 1d, scoreTypes);
        bestTargetScore.put(ScoreType.CorrCoelution.getName(), 0d, scoreTypes);
        bestTargetScore.put(ScoreType.CorrCoelutionW.getName(), 0d, scoreTypes);
        bestTargetScore.put(ScoreType.LibCorr.getName(), 1d, scoreTypes);
        bestTargetScore.put(ScoreType.LibApexCorr.getName(), 1d, scoreTypes);
        bestTargetScore.put(ScoreType.LibShift.getName(), 0d, scoreTypes);
        bestTargetScore.put(ScoreType.LibRsmd.getName(), 0d, scoreTypes);
        bestTargetScore.put(ScoreType.LibManhattan.getName(), 0d, scoreTypes);
        bestTargetScore.put(ScoreType.LibDotprod.getName(), 1d, scoreTypes);
        bestTargetScore.put(ScoreType.LibSangle.getName(), 0d, scoreTypes);
        ...
        bestTargetScore.put(ScoreType.MassdevScoreW.getName(), 0d, scoreTypes);
