...
public class PredictTheorySp {
    ...
    public double[][] predict_single_pep(String pepStr, String spModel,
                                         int iso_num) {
        if (pepStr.contains("#")) {
    ...
    public void predict(String pep_file, String out_file, String spModel,
                        int iso_num) {
        ...
        try {
            ...
            for (String iter_pep : pep_list) {
                ...
                outfile.write(simu.MGF_format(peak_group, spModel, rank));
                outfile.flush();
                outfile.close();
            }
        } catch (Exception e) {
...
//        SimuConst.parameter = new Parameters2();
